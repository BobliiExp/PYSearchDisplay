...
@interface ViewController () <UITableViewDelegate, UITableViewDataSource, PYSearchDisplayDelegate>


@property (nonatomic, strong) UISearchBar       *searchBar;                 ///< 查询框
@property (nonatomic, strong) PYSearchDisplay  *searchDisp;                ///< 自定义展示查询界面控件
...
- (void)setup {
    ...
    self.searchDisp = [[PYSearchDisplay alloc] initWithSearchBar:self.searchBar viewController:self];
