...
@protocol PYSearchDisplayDelegate;
...
@interface PYSearchDisplay : UIImageView <UIScrollViewDelegate>

@property (nonatomic, readonly, nullable) UISearchBar                 *searchBar;    ///< 查询
@property (nonatomic, readonly, nullable) UIViewController           *viewController;
@property (nonatomic, assign, nullable)   id<PYSearchDisplayDelegate> delegate;
...
@protocol PYSearchDisplayDelegate <NSObject>

@optional

- (void)displayWillShow:(PYSearchDisplay*)display searchBar:(UISearchBar*)searchBar;
- (void)displayWillHide:(PYSearchDisplay*)display searchBar:(UISearchBar*)searchBar;
