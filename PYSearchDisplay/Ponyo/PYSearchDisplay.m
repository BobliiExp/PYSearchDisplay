...
@interface PYSearchDisplay() <UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate> {
...
@implementation PYSearchDisplay
...
- (void)setHidden:(BOOL)hidden {
    ...
    if(!hidden){
        ...
        [UIView animateWithDuration:0.2
                         ...
                         animations:^{
                             UIImage *img = [PYSearchDisplay imageWithScreenShoot];
...
- (UIView*)tableViewHeader {
    ...
    for(NSInteger i=0; i<shortLook.count; i++){
        ...
        [btn setBackgroundImage:[PYSearchDisplay imageWithColor:[UIColor blueColor]] forState:UIControlStateSelected];
